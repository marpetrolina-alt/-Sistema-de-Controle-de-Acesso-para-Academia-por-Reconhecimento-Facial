...
<head>
    ...
    <title>Cadastrar Aluno - Academia</title>
...
<div class="alunos-layout">
    ...
    <main class="content">
        ...
        <section class="students-panel">
            ...
            <form method="POST"
                  action="/teste-github/-Sistema-de-Controle-de-Acesso-para-Academia-por-Reconhecimento-Facial-main/public/alunos/store"
                  class="student-form">
